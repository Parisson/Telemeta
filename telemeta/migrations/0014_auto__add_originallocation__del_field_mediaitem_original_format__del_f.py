...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MediaItem.original_format'
        db.delete_column('media_items', 'original_format_id')

        # Deleting field 'Format.status'
        db.delete_column('media_formats', 'status')

        # Deleting field 'Format.audio_quality'
        db.delete_column('media_formats', 'audio_quality')

        # Deleting field 'Format.wheel_diameter'
        db.delete_column('media_formats', 'wheel_diameter_id')

        # Deleting field 'Format.tape_width'
        db.delete_column('media_formats', 'tape_width_id')

        # Deleting field 'Format.conservation_state'
        db.delete_column('media_formats', 'conservation_state')

        # Deleting field 'Format.comments'
        db.delete_column('media_formats', 'comments')

        # Deleting field 'Format.channels'
        db.delete_column('media_formats', 'channels')

        # Deleting field 'Format.original_format_number'
        db.delete_column('media_formats', 'original_format_number')

        # Deleting field 'Format.tape_diameter'
        db.delete_column('media_formats', 'tape_diameter')

        # Adding field 'Format.item'
        db.add_column('media_formats', 'item',
                      self.gf('telemeta.models.core.ForeignKey')(default=1, related_name='format', to=orm['telemeta.MediaItem']),
                      keep_default=False)

        # Adding field 'Format.original_number'
        db.add_column('media_formats', 'original_number',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Format.original_status'
        db.add_column('media_formats', 'original_status',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Format.original_state'
        db.add_column('media_formats', 'original_state',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Format.original_comments'
        db.add_column('media_formats', 'original_comments',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Format.original_location'
        db.add_column('media_formats', 'original_location',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='format', null=True, blank=True, to=orm['telemeta.OriginalLocation']),
                      keep_default=False)

        # Adding field 'Format.original_channels'
        db.add_column('media_formats', 'original_channels',
                      self.gf('telemeta.models.core.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Format.original_audio_quality'
        db.add_column('media_formats', 'original_audio_quality',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Format.tape_wheel_diameter'
        db.add_column('media_formats', 'tape_wheel_diameter',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='format', null=True, blank=True, to=orm['telemeta.WheelDiameter']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'MediaItem.original_format'
        db.add_column('media_items', 'original_format',
                      self.gf('telemeta.models.core.ForeignKey')(related_name='item', on_delete=models.SET_NULL, default=None, to=orm['telemeta.Format'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'Format.status'
        db.add_column('media_formats', 'status',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Format.audio_quality'
        db.add_column('media_formats', 'audio_quality',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Format.wheel_diameter'
        db.add_column('media_formats', 'wheel_diameter',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='format', null=True, to=orm['telemeta.WheelDiameter'], blank=True),
                      keep_default=False)

        # Adding field 'Format.tape_width'
        db.add_column('media_formats', 'tape_width',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='format', null=True, to=orm['telemeta.TapeWidth'], blank=True),
                      keep_default=False)

        # Adding field 'Format.conservation_state'
        db.add_column('media_formats', 'conservation_state',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Format.comments'
        db.add_column('media_formats', 'comments',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Format.channels'
        db.add_column('media_formats', 'channels',
                      self.gf('telemeta.models.core.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Format.original_format_number'
        db.add_column('media_formats', 'original_format_number',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Format.tape_diameter'
        db.add_column('media_formats', 'tape_diameter',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Deleting field 'Format.item'
        db.delete_column('media_formats', 'item_id')

        # Deleting field 'Format.original_number'
        db.delete_column('media_formats', 'original_number')

        # Deleting field 'Format.original_status'
        db.delete_column('media_formats', 'original_status')

        # Deleting field 'Format.original_state'
        db.delete_column('media_formats', 'original_state')

        # Deleting field 'Format.original_comments'
        db.delete_column('media_formats', 'original_comments')

        # Deleting field 'Format.original_location'
        db.delete_column('media_formats', 'original_location_id')

        # Deleting field 'Format.original_channels'
        db.delete_column('media_formats', 'original_channels')

        # Deleting field 'Format.original_audio_quality'
        db.delete_column('media_formats', 'original_audio_quality')

        # Deleting field 'Format.tape_wheel_diameter'
        db.delete_column('media_formats', 'tape_wheel_diameter_id')
    ...
    models = {
        ...
        'telemeta.format': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('telemeta.models.core.ForeignKey', [], {'related_name': "'format'", 'to': "orm['telemeta.MediaItem']"}),
            'original_audio_quality': ('telemeta.models.core.TextField', [], {'default': "''", 'blank': 'True'}),
            'original_channels': ('telemeta.models.core.IntegerField', [], {'default': '0', 'blank': 'True'}),
            ...
            'original_location': ('telemeta.models.core.WeakForeignKey', [], {'default': 'None', 'related_name': "'format'", 'null': 'True', 'blank': 'True', 'to': "orm['telemeta.OriginalLocation']"}),
            ...
            'tape_wheel_diameter': ('telemeta.models.core.WeakForeignKey', [], {'default': 'None', 'related_name': "'format'", 'null': 'True', 'blank': 'True', 'to': "orm['telemeta.WheelDiameter']"})
        },
        ...
        'telemeta.originallocation': {
            'Meta': {'ordering': "['value']", 'object_name': 'OriginalLocation', 'db_table': "'original_location'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('telemeta.models.core.CharField', [], {'unique': 'True', 'max_length': '250'})
        },
