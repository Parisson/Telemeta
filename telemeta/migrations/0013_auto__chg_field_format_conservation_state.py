...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Format.conservation_state'
        db.alter_column('media_formats', 'conservation_state', self.gf('telemeta.models.core.TextField')())
    def backwards(self, orm):

        # Changing field 'Format.conservation_state'
        db.alter_column('media_formats', 'conservation_state', self.gf('telemeta.models.core.CharField')(max_length=250))
    models = {
        'auth.group': {
