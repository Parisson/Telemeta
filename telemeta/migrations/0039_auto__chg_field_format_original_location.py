...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('media_formats', 'original_location_id', self.gf('telemeta.models.fields.WeakForeignKey')(null=True, to=orm['telemeta.ConservationSite']))
    ...
    models = {
        ...
        'telemeta.format': {
            ...
            'original_location': ('telemeta.models.fields.WeakForeignKey', [], {'default': 'None', 'related_name': "'format'", 'null': 'True', 'blank': 'True', 'to': "orm['telemeta.ConservationSite']"}),
