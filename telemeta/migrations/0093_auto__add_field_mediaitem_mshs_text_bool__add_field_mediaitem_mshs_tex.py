...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaItem.mshs_text_bool'
        db.add_column('media_items', 'mshs_text_bool',
                      self.gf('telemeta.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_text'
        db.add_column('media_items', 'mshs_text',
                      self.gf('telemeta.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_incipit'
        db.add_column('media_items', 'mshs_incipit',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_refrain'
        db.add_column('media_items', 'mshs_refrain',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_jingle'
        db.add_column('media_items', 'mshs_jingle',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_coupe'
        db.add_column('media_items', 'mshs_coupe',
                      self.gf('telemeta.models.fields.WeakForeignKey')(default=None, to=orm['telemeta.Coupe'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaItem.mshs_text_bool'
        db.delete_column('media_items', 'mshs_text_bool')

        # Deleting field 'MediaItem.mshs_text'
        db.delete_column('media_items', 'mshs_text')

        # Deleting field 'MediaItem.mshs_incipit'
        db.delete_column('media_items', 'mshs_incipit')

        # Deleting field 'MediaItem.mshs_refrain'
        db.delete_column('media_items', 'mshs_refrain')

        # Deleting field 'MediaItem.mshs_jingle'
        db.delete_column('media_items', 'mshs_jingle')

        # Deleting field 'MediaItem.mshs_coupe'
        db.delete_column('media_items', 'mshs_coupe_id')
