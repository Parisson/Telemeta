...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaItem.mshs_deposit_digest'
        db.add_column('media_items', 'mshs_deposit_digest',
                      self.gf('telemeta.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_deposit_thematic'
        db.add_column('media_items', 'mshs_deposit_thematic',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_deposit_names'
        db.add_column('media_items', 'mshs_deposit_names',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_deposit_places'
        db.add_column('media_items', 'mshs_deposit_places',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_deposit_periods'
        db.add_column('media_items', 'mshs_deposit_periods',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaItem.mshs_deposit_digest'
        db.delete_column('media_items', 'mshs_deposit_digest')

        # Deleting field 'MediaItem.mshs_deposit_thematic'
        db.delete_column('media_items', 'mshs_deposit_thematic')

        # Deleting field 'MediaItem.mshs_deposit_names'
        db.delete_column('media_items', 'mshs_deposit_names')

        # Deleting field 'MediaItem.mshs_deposit_places'
        db.delete_column('media_items', 'mshs_deposit_places')

        # Deleting field 'MediaItem.mshs_deposit_periods'
        db.delete_column('media_items', 'mshs_deposit_periods')
