...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('telemeta', ['NumberOfChannels'])

        # Deleting field 'Format.original_format'
        db.delete_column('media_formats', 'original_format_id')

        # Adding field 'Format.physical_format'
        db.add_column('media_formats', 'physical_format',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='format', null=True, blank=True, to=orm['telemeta.PhysicalFormat']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NumberOfChannels'
        db.delete_table('original_channel_number')

        # Adding field 'Format.original_format'
        db.add_column('media_formats', 'original_format',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='format', null=True, to=orm['telemeta.OriginalFormat'], blank=True),
                      keep_default=False)

        # Deleting field 'Format.physical_format'
        db.delete_column('media_formats', 'physical_format_id')
