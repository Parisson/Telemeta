...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('telemeta', ['FunctionMSHS'])

        # Deleting field 'MediaItem.mshs_ch_function'
        db.delete_column('media_items', 'mshs_ch_function')

        # Adding field 'MediaItem.mshs_function'
        db.add_column('media_items', 'mshs_function',
                      self.gf('telemeta.models.fields.WeakForeignKey')(default=None, to=orm['telemeta.FunctionMSHS'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FunctionMSHS'
        db.delete_table('function')

        # Adding field 'MediaItem.mshs_ch_function'
        db.add_column('media_items', 'mshs_ch_function',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Deleting field 'MediaItem.mshs_function'
        db.delete_column('media_items', 'mshs_function_id')
