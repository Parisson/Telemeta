...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('telemeta', ['Topic'])

        # Deleting field 'MediaItem.subject'
        db.delete_column('media_items', 'subject_id')

        # Adding field 'MediaItem.topic'
        db.add_column('media_items', 'topic',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, to=orm['telemeta.Topic'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal('telemeta', ['Subject'])

        # Deleting model 'Topic'
        db.delete_table('topic')

        # Adding field 'MediaItem.subject'
        db.add_column('media_items', 'subject',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, to=orm['telemeta.Subject'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MediaItem.topic'
        db.delete_column('media_items', 'topic_id')
