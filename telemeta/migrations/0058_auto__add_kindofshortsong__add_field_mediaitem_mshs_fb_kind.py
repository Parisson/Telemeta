...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KindOfShortSong'
        db.create_table('knidofshortsong', (
        ...
        db.send_create_signal('telemeta', ['KindOfShortSong'])
    ...
    def backwards(self, orm):
        # Deleting model 'KindOfShortSong'
        db.delete_table('knidofshortsong')
