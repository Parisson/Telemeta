...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MediaItem.mshs_format'
        db.delete_column('media_items', 'mshs_format')


    def backwards(self, orm):
        # Adding field 'MediaItem.mshs_format'
        db.add_column('media_items', 'mshs_format',
                      self.gf('django.db.models.fields.CharField')(default='TE', max_length=2),
                      keep_default=False)
