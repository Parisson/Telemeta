...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MediaItem.mshs_te_digest'
        db.delete_column('media_items', 'mshs_te_digest')

        # Deleting field 'MediaItem.mshs_mu_alt_title'
        db.delete_column('media_items', 'mshs_mu_alt_title')

        # Deleting field 'MediaItem.mshs_te_names'
        db.delete_column('media_items', 'mshs_te_names')

        # Deleting field 'MediaItem.mshs_ch_code_coirault'
        db.delete_column('media_items', 'mshs_ch_code_coirault')

        # Deleting field 'MediaItem.mshs_ch_title'
        db.delete_column('media_items', 'mshs_ch_title')

        # Deleting field 'MediaItem.mshs_mu_author'
        db.delete_column('media_items', 'mshs_mu_author')

        # Deleting field 'MediaItem.mshs_co_code_Aare'
        db.delete_column('media_items', 'mshs_co_code_Aare')

        # Deleting field 'MediaItem.mshs_mu_details_tune'
        db.delete_column('media_items', 'mshs_mu_details_tune')

        # Deleting field 'MediaItem.mshs_ch_kind'
        db.delete_column('media_items', 'mshs_ch_kind_id')

        # Deleting field 'MediaItem.mshs_fb_author'
        db.delete_column('media_items', 'mshs_fb_author')

        # Deleting field 'MediaItem.mshs_fb_alt_title'
        db.delete_column('media_items', 'mshs_fb_alt_title')

        # Deleting field 'MediaItem.mshs_ch_refrain'
        db.delete_column('media_items', 'mshs_ch_refrain')

        # Deleting field 'MediaItem.mshs_fb_refrain'
        db.delete_column('media_items', 'mshs_fb_refrain')

        # Deleting field 'MediaItem.mshs_co_author'
        db.delete_column('media_items', 'mshs_co_author')

        # Deleting field 'MediaItem.mshs_fb_details'
        db.delete_column('media_items', 'mshs_fb_details')

        # Deleting field 'MediaItem.mshs_co_title_ref_Aare'
        db.delete_column('media_items', 'mshs_co_title_ref_Aare')

        # Deleting field 'MediaItem.mshs_mu_dance'
        db.delete_column('media_items', 'mshs_mu_dance')

        # Deleting field 'MediaItem.mshs_fb_incipit'
        db.delete_column('media_items', 'mshs_fb_incipit')

        # Deleting field 'MediaItem.mshs_mu_details'
        db.delete_column('media_items', 'mshs_mu_details')

        # Deleting field 'MediaItem.mshs_co_code_Dela'
        db.delete_column('media_items', 'mshs_co_code_Dela')

        # Deleting field 'MediaItem.mshs_mu_gavotte_bool'
        db.delete_column('media_items', 'mshs_mu_gavotte_bool')

        # Deleting field 'MediaItem.mshs_fb_kind'
        db.delete_column('media_items', 'mshs_fb_kind_id')

        # Deleting field 'MediaItem.mshs_mu_timbre'
        db.delete_column('media_items', 'mshs_mu_timbre')

        # Deleting field 'MediaItem.mshs_ch_author'
        db.delete_column('media_items', 'mshs_ch_author')

        # Deleting field 'MediaItem.mshs_ch_alt_title'
        db.delete_column('media_items', 'mshs_ch_alt_title')

        # Deleting field 'MediaItem.mshs_fb_title'
        db.delete_column('media_items', 'mshs_fb_title')

        # Deleting field 'MediaItem.mshs_ch_coupe'
        db.delete_column('media_items', 'mshs_ch_coupe_id')

        # Deleting field 'MediaItem.mshs_te_details'
        db.delete_column('media_items', 'mshs_te_details')

        # Deleting field 'MediaItem.mshs_co_alt_title'
        db.delete_column('media_items', 'mshs_co_alt_title')

        # Deleting field 'MediaItem.mshs_mu_details_dance'
        db.delete_column('media_items', 'mshs_mu_details_dance')

        # Deleting field 'MediaItem.mshs_mu_title'
        db.delete_column('media_items', 'mshs_mu_title')

        # Deleting field 'MediaItem.mshs_ch_timbre'
        db.delete_column('media_items', 'mshs_ch_timbre')

        # Deleting field 'MediaItem.mshs_te_places'
        db.delete_column('media_items', 'mshs_te_places')

        # Deleting field 'MediaItem.mshs_fb_timbre'
        db.delete_column('media_items', 'mshs_fb_timbre')

        # Deleting field 'MediaItem.mshs_co_title_ref_Dela'
        db.delete_column('media_items', 'mshs_co_title_ref_Dela')

        # Deleting field 'MediaItem.mshs_co_title'
        db.delete_column('media_items', 'mshs_co_title')

        # Deleting field 'MediaItem.mshs_ch_title_ref_coirault'
        db.delete_column('media_items', 'mshs_ch_title_ref_coirault')

        # Deleting field 'MediaItem.mshs_co_kind'
        db.delete_column('media_items', 'mshs_co_kind_id')

        # Deleting field 'MediaItem.mshs_te_thematic'
        db.delete_column('media_items', 'mshs_te_thematic')

        # Deleting field 'MediaItem.mshs_ch_title_ref_laforte'
        db.delete_column('media_items', 'mshs_ch_title_ref_laforte')

        # Deleting field 'MediaItem.mshs_ch_composer'
        db.delete_column('media_items', 'mshs_ch_composer')

        # Deleting field 'MediaItem.mshs_ch_incipit'
        db.delete_column('media_items', 'mshs_ch_incipit')

        # Deleting field 'MediaItem.mshs_ch_details'
        db.delete_column('media_items', 'mshs_ch_details')

        # Deleting field 'MediaItem.mshs_co_jingle'
        db.delete_column('media_items', 'mshs_co_jingle')

        # Deleting field 'MediaItem.mshs_mu_gavotte'
        db.delete_column('media_items', 'mshs_mu_gavotte')

        # Deleting field 'MediaItem.mshs_fb_composer'
        db.delete_column('media_items', 'mshs_fb_composer')

        # Deleting field 'MediaItem.mshs_ch_code_laforte'
        db.delete_column('media_items', 'mshs_ch_code_laforte')

        # Deleting field 'MediaItem.mshs_mu_composer'
        db.delete_column('media_items', 'mshs_mu_composer')

        # Deleting field 'MediaItem.mshs_te_periods'
        db.delete_column('media_items', 'mshs_te_periods')

        # Adding field 'MediaItem.mshs_author'
        db.add_column('media_items', 'mshs_author',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_composer'
        db.add_column('media_items', 'mshs_composer',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_timbre'
        db.add_column('media_items', 'mshs_timbre',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_timbre_ref'
        db.add_column('media_items', 'mshs_timbre_ref',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_timbre_code'
        db.add_column('media_items', 'mshs_timbre_code',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_alt_title'
        db.add_column('media_items', 'mshs_alt_title',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_melody'
        db.add_column('media_items', 'mshs_melody',
                      self.gf('telemeta.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_domain_song'
        db.add_column('media_items', 'mshs_domain_song',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_domain_vocal'
        db.add_column('media_items', 'mshs_domain_vocal',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_domain_music'
        db.add_column('media_items', 'mshs_domain_music',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_domain_tale'
        db.add_column('media_items', 'mshs_domain_tale',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_details'
        db.add_column('media_items', 'mshs_details',
                      self.gf('telemeta.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_dance'
        db.add_column('media_items', 'mshs_dance',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_dance_details'
        db.add_column('media_items', 'mshs_dance_details',
                      self.gf('telemeta.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Renaming column for 'MediaItem.mshs_function' to match new field type.
        db.rename_column('media_items', 'mshs_function_id', 'mshs_function')
        # Changing field 'MediaItem.mshs_function'
        db.alter_column('media_items', 'mshs_function', self.gf('telemeta.models.fields.CharField')(max_length=250))
        # Removing index on 'MediaItem', fields ['mshs_function']
        db.delete_index('media_items', ['mshs_function_id'])


    def backwards(self, orm):
        # Adding index on 'MediaItem', fields ['mshs_function']
        db.create_index('media_items', ['mshs_function_id'])

        # Adding field 'MediaItem.mshs_te_digest'
        db.add_column('media_items', 'mshs_te_digest',
                      self.gf('telemeta.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_alt_title'
        db.add_column('media_items', 'mshs_mu_alt_title',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_te_names'
        db.add_column('media_items', 'mshs_te_names',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_code_coirault'
        db.add_column('media_items', 'mshs_ch_code_coirault',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_title'
        db.add_column('media_items', 'mshs_ch_title',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_author'
        db.add_column('media_items', 'mshs_mu_author',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_co_code_Aare'
        db.add_column('media_items', 'mshs_co_code_Aare',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_details_tune'
        db.add_column('media_items', 'mshs_mu_details_tune',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_kind'
        db.add_column('media_items', 'mshs_ch_kind',
                      self.gf('telemeta.models.fields.WeakForeignKey')(default=None, to=orm['telemeta.KindOfSong'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_fb_author'
        db.add_column('media_items', 'mshs_fb_author',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_fb_alt_title'
        db.add_column('media_items', 'mshs_fb_alt_title',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_refrain'
        db.add_column('media_items', 'mshs_ch_refrain',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_fb_refrain'
        db.add_column('media_items', 'mshs_fb_refrain',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_co_author'
        db.add_column('media_items', 'mshs_co_author',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_fb_details'
        db.add_column('media_items', 'mshs_fb_details',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_co_title_ref_Aare'
        db.add_column('media_items', 'mshs_co_title_ref_Aare',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_dance'
        db.add_column('media_items', 'mshs_mu_dance',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_fb_incipit'
        db.add_column('media_items', 'mshs_fb_incipit',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_details'
        db.add_column('media_items', 'mshs_mu_details',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_co_code_Dela'
        db.add_column('media_items', 'mshs_co_code_Dela',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_gavotte_bool'
        db.add_column('media_items', 'mshs_mu_gavotte_bool',
                      self.gf('telemeta.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_fb_kind'
        db.add_column('media_items', 'mshs_fb_kind',
                      self.gf('telemeta.models.fields.WeakForeignKey')(default=None, to=orm['telemeta.KindOfShortSong'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_timbre'
        db.add_column('media_items', 'mshs_mu_timbre',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_author'
        db.add_column('media_items', 'mshs_ch_author',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_alt_title'
        db.add_column('media_items', 'mshs_ch_alt_title',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_fb_title'
        db.add_column('media_items', 'mshs_fb_title',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_coupe'
        db.add_column('media_items', 'mshs_ch_coupe',
                      self.gf('telemeta.models.fields.WeakForeignKey')(default=None, to=orm['telemeta.Coupe'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_te_details'
        db.add_column('media_items', 'mshs_te_details',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_co_alt_title'
        db.add_column('media_items', 'mshs_co_alt_title',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_details_dance'
        db.add_column('media_items', 'mshs_mu_details_dance',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_title'
        db.add_column('media_items', 'mshs_mu_title',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_timbre'
        db.add_column('media_items', 'mshs_ch_timbre',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_te_places'
        db.add_column('media_items', 'mshs_te_places',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_fb_timbre'
        db.add_column('media_items', 'mshs_fb_timbre',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_co_title_ref_Dela'
        db.add_column('media_items', 'mshs_co_title_ref_Dela',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_co_title'
        db.add_column('media_items', 'mshs_co_title',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_title_ref_coirault'
        db.add_column('media_items', 'mshs_ch_title_ref_coirault',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_co_kind'
        db.add_column('media_items', 'mshs_co_kind',
                      self.gf('telemeta.models.fields.WeakForeignKey')(default=None, to=orm['telemeta.KindOfTale'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_te_thematic'
        db.add_column('media_items', 'mshs_te_thematic',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_title_ref_laforte'
        db.add_column('media_items', 'mshs_ch_title_ref_laforte',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_composer'
        db.add_column('media_items', 'mshs_ch_composer',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_incipit'
        db.add_column('media_items', 'mshs_ch_incipit',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_details'
        db.add_column('media_items', 'mshs_ch_details',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_co_jingle'
        db.add_column('media_items', 'mshs_co_jingle',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_gavotte'
        db.add_column('media_items', 'mshs_mu_gavotte',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_fb_composer'
        db.add_column('media_items', 'mshs_fb_composer',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_ch_code_laforte'
        db.add_column('media_items', 'mshs_ch_code_laforte',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_mu_composer'
        db.add_column('media_items', 'mshs_mu_composer',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_te_periods'
        db.add_column('media_items', 'mshs_te_periods',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Deleting field 'MediaItem.mshs_author'
        db.delete_column('media_items', 'mshs_author')

        # Deleting field 'MediaItem.mshs_composer'
        db.delete_column('media_items', 'mshs_composer')

        # Deleting field 'MediaItem.mshs_timbre'
        db.delete_column('media_items', 'mshs_timbre')

        # Deleting field 'MediaItem.mshs_timbre_ref'
        db.delete_column('media_items', 'mshs_timbre_ref')

        # Deleting field 'MediaItem.mshs_timbre_code'
        db.delete_column('media_items', 'mshs_timbre_code')

        # Deleting field 'MediaItem.mshs_alt_title'
        db.delete_column('media_items', 'mshs_alt_title')

        # Deleting field 'MediaItem.mshs_melody'
        db.delete_column('media_items', 'mshs_melody')

        # Deleting field 'MediaItem.mshs_domain_song'
        db.delete_column('media_items', 'mshs_domain_song')

        # Deleting field 'MediaItem.mshs_domain_vocal'
        db.delete_column('media_items', 'mshs_domain_vocal')

        # Deleting field 'MediaItem.mshs_domain_music'
        db.delete_column('media_items', 'mshs_domain_music')

        # Deleting field 'MediaItem.mshs_domain_tale'
        db.delete_column('media_items', 'mshs_domain_tale')

        # Deleting field 'MediaItem.mshs_details'
        db.delete_column('media_items', 'mshs_details')

        # Deleting field 'MediaItem.mshs_dance'
        db.delete_column('media_items', 'mshs_dance')

        # Deleting field 'MediaItem.mshs_dance_details'
        db.delete_column('media_items', 'mshs_dance_details')


        # Renaming column for 'MediaItem.mshs_function' to match new field type.
        db.rename_column('media_items', 'mshs_function', 'mshs_function_id')
        # Changing field 'MediaItem.mshs_function'
        db.alter_column('media_items', 'mshs_function_id', self.gf('telemeta.models.fields.WeakForeignKey')(to=orm['telemeta.FunctionMSHS'], null=True))
    ...
    models = {
        ...
        'telemeta.coupe': {
            'Meta': {'ordering': "['value']", 'object_name': 'Coupe', 'db_table': "'coupe'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('telemeta.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'value': ('telemeta.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'})
        },
        ...
        'telemeta.functionmshs': {
            'Meta': {'ordering': "['value']", 'object_name': 'FunctionMSHS', 'db_table': "'function'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('telemeta.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'value': ('telemeta.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'})
        },
        ...
        'telemeta.kindofshortsong': {
            'Meta': {'ordering': "['value']", 'object_name': 'KindOfShortSong', 'db_table': "'knidofshortsong'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('telemeta.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'value': ('telemeta.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'})
        },
        'telemeta.kindofsong': {
            'Meta': {'ordering': "['value']", 'object_name': 'KindOfSong', 'db_table': "'knidofsong'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('telemeta.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'value': ('telemeta.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'})
        },
        'telemeta.kindoftale': {
            'Meta': {'ordering': "['value']", 'object_name': 'KindOfTale', 'db_table': "'knidoftale'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('telemeta.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'value': ('telemeta.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'})
        },
        ...
        'telemeta.mediaitem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'informer': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            ...
            'mshs_alt_title': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_author': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_composer': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_dance': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_dance_details': ('telemeta.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'mshs_details': ('telemeta.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'mshs_domain_music': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_domain_song': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_domain_tale': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_domain_vocal': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_function': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_melody': ('telemeta.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'mshs_timbre': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_timbre_code': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'mshs_timbre_ref': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
