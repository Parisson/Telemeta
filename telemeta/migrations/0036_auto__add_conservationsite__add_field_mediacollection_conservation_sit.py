...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConservationSite'
        db.create_table('conservation_sites', (
        ...
        db.send_create_signal('telemeta', ['ConservationSite'])
    ...
    def backwards(self, orm):
        # Deleting model 'ConservationSite'
        db.delete_table('conservation_sites')
    ...
    models = {
        ...
        'telemeta.mediacollection': {
            ...
            'conservation_site2': ('telemeta.models.fields.WeakForeignKey', [], {'default': 'None', 'related_name': "'collections'", 'null': 'True', 'blank': 'True', 'to': "orm['telemeta.ConservationSite']"}),
