...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('media_item_identifier', 'identifier', self.gf('telemeta.models.core.CharField')(unique=True, max_length=255))

        # Changing field 'MediaCollectionIdentifier.identifier'
        db.alter_column('media_collection_identifier', 'identifier', self.gf('telemeta.models.core.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'MediaItemIdentifier.identifier'
        db.alter_column('media_item_identifier', 'identifier', self.gf('telemeta.models.core.CharField')(max_length=1024, unique=True))

        # Changing field 'MediaCollectionIdentifier.identifier'
        db.alter_column('media_collection_identifier', 'identifier', self.gf('telemeta.models.core.CharField')(max_length=1024, unique=True))
