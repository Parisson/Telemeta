...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MediaItem.vernacular_style'
        db.delete_column('media_items', 'vernacular_style_id')

        # Adding field 'MediaItem.associated_researchers'
        db.add_column('media_items', 'associated_researchers',
        ...
        db.alter_column('media_formats', 'original_status', self.gf('telemeta.models.fields.CharField')(max_length=20))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'MediaItem.vernacular_style'
        db.add_column('media_items', 'vernacular_style',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='items', null=True, to=orm['telemeta.VernacularStyle'], blank=True),
                      keep_default=False)

        # Deleting field 'MediaItem.associated_researchers'
        db.delete_column('media_items', 'associated_researchers')
