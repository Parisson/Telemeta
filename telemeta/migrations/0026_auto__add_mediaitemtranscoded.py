...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MediaItemTranscoded'
        db.create_table('telemeta_media_transcoded', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='transcoded', to=orm['telemeta.MediaItem'])),
        ...
        db.send_create_signal('telemeta', ['MediaItemTranscoded'])

    def backwards(self, orm):
        # Deleting model 'MediaItemTranscoded'
        db.delete_table('telemeta_media_transcoded')
