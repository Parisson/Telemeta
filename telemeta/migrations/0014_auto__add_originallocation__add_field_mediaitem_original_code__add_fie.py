...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MediaItem.original_code'
        db.add_column('media_items', 'original_code',
                      self.gf('telemeta.models.core.CharField')(default=1, max_length=250),
                      keep_default=False)

        # Adding field 'MediaItem.original_number'
        db.add_column('media_items', 'original_number',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.original_status'
        db.add_column('media_items', 'original_status',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.original_state'
        db.add_column('media_items', 'original_state',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.original_comments'
        db.add_column('media_items', 'original_comments',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.original_location'
        db.add_column('media_items', 'original_location',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='item', null=True, blank=True, to=orm['telemeta.OriginalLocation']),
                      keep_default=False)

        # Adding field 'MediaItem.original_channels'
        db.add_column('media_items', 'original_channels',
                      self.gf('telemeta.models.core.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.audio_quality'
        db.add_column('media_items', 'audio_quality',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.recording_system'
        db.add_column('media_items', 'recording_system',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.tape_wheel_diameter'
        db.add_column('media_items', 'tape_wheel_diameter',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='item', null=True, blank=True, to=orm['telemeta.WheelDiameter']),
                      keep_default=False)

        # Adding field 'MediaItem.tape_thickness'
        db.add_column('media_items', 'tape_thickness',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.tape_speed'
        db.add_column('media_items', 'tape_speed',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='item', null=True, blank=True, to=orm['telemeta.TapeSpeed']),
                      keep_default=False)

        # Adding field 'MediaItem.tape_vendor'
        db.add_column('media_items', 'tape_vendor',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='item', null=True, blank=True, to=orm['telemeta.TapeVendor']),
                      keep_default=False)

        # Adding field 'MediaItem.tape_reference'
        db.add_column('media_items', 'tape_reference',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.sticker_presence'
        db.add_column('media_items', 'sticker_presence',
                      self.gf('telemeta.models.core.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'MediaItem.original_format'
        db.alter_column('media_items', 'original_format_id', self.gf('telemeta.models.core.WeakForeignKey')(null=True, to=orm['telemeta.OriginalFormat']))
    def backwards(self, orm):
        # Deleting model 'OriginalLocation'
        db.delete_table('original_location')

        # Deleting field 'MediaItem.original_code'
        db.delete_column('media_items', 'original_code')

        # Deleting field 'MediaItem.original_number'
        db.delete_column('media_items', 'original_number')

        # Deleting field 'MediaItem.original_status'
        db.delete_column('media_items', 'original_status')

        # Deleting field 'MediaItem.original_state'
        db.delete_column('media_items', 'original_state')

        # Deleting field 'MediaItem.original_comments'
        db.delete_column('media_items', 'original_comments')

        # Deleting field 'MediaItem.original_location'
        db.delete_column('media_items', 'original_location_id')

        # Deleting field 'MediaItem.original_channels'
        db.delete_column('media_items', 'original_channels')

        # Deleting field 'MediaItem.audio_quality'
        db.delete_column('media_items', 'audio_quality')

        # Deleting field 'MediaItem.recording_system'
        db.delete_column('media_items', 'recording_system')

        # Deleting field 'MediaItem.tape_wheel_diameter'
        db.delete_column('media_items', 'tape_wheel_diameter_id')

        # Deleting field 'MediaItem.tape_thickness'
        db.delete_column('media_items', 'tape_thickness')

        # Deleting field 'MediaItem.tape_speed'
        db.delete_column('media_items', 'tape_speed_id')

        # Deleting field 'MediaItem.tape_vendor'
        db.delete_column('media_items', 'tape_vendor_id')

        # Deleting field 'MediaItem.tape_reference'
        db.delete_column('media_items', 'tape_reference')

        # Deleting field 'MediaItem.sticker_presence'
        db.delete_column('media_items', 'sticker_presence')


        # Changing field 'MediaItem.original_format'
        db.alter_column('media_items', 'original_format_id', self.gf('telemeta.models.core.ForeignKey')(on_delete=models.SET_NULL, to=orm['telemeta.Format'], null=True))
    models = {
        'auth.group': {
        ...
        'telemeta.mediaitem': {
            ...
            'original_format': ('telemeta.models.core.WeakForeignKey', [], {'default': 'None', 'related_name': "'item'", 'null': 'True', 'blank': 'True', 'to': "orm['telemeta.OriginalFormat']"}),
            'original_location': ('telemeta.models.core.WeakForeignKey', [], {'default': 'None', 'related_name': "'item'", 'null': 'True', 'blank': 'True', 'to': "orm['telemeta.OriginalLocation']"}),
            ...
            'sticker_presence': ('telemeta.models.core.BooleanField', [], {'default': 'False'}),
            'tape_reference': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'tape_speed': ('telemeta.models.core.WeakForeignKey', [], {'default': 'None', 'related_name': "'item'", 'null': 'True', 'blank': 'True', 'to': "orm['telemeta.TapeSpeed']"}),
            'tape_thickness': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'tape_vendor': ('telemeta.models.core.WeakForeignKey', [], {'default': 'None', 'related_name': "'item'", 'null': 'True', 'blank': 'True', 'to': "orm['telemeta.TapeVendor']"}),
            'tape_wheel_diameter': ('telemeta.models.core.WeakForeignKey', [], {'default': 'None', 'related_name': "'item'", 'null': 'True', 'blank': 'True', 'to': "orm['telemeta.WheelDiameter']"}),
            'title': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
