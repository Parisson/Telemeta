...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MediaCorpus.reference'
        db.delete_column('media_corpus', 'reference')

        # Adding field 'MediaCorpus.descriptions'
        db.add_column('media_corpus', 'descriptions',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'MediaFonds.reference'
        db.delete_column('media_fonds', 'reference')

        # Adding field 'MediaFonds.descriptions'
        db.add_column('media_fonds', 'descriptions',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('media_corpus', 'reference',
                      self.gf('telemeta.models.core.CharField')(default=None, unique=True, max_length=250, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MediaCorpus.descriptions'
        db.delete_column('media_corpus', 'descriptions')

        # Adding field 'MediaFonds.reference'
        db.add_column('media_fonds', 'reference',
                      self.gf('telemeta.models.core.CharField')(default=None, unique=True, max_length=250, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MediaFonds.descriptions'
        db.delete_column('media_fonds', 'descriptions')
