...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.init_password'
        db.add_column('profiles', 'init_password',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.init_password'
        db.delete_column('profiles', 'init_password')
