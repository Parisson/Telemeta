...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KindOfTale'
        db.create_table('knidoftale', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('telemeta.models.fields.CharField')(unique=True, max_length=250)),
            ('notes', self.gf('telemeta.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal('telemeta', ['KindOfTale'])
    ...
    def backwards(self, orm):
        # Deleting model 'KindOfTale'
        db.delete_table('knidoftale')
