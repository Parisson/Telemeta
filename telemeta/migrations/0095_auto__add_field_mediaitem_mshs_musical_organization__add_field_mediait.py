...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaItem.mshs_musical_organization'
        db.add_column('media_items', 'mshs_musical_organization',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'MediaItem.mshs_group'
        db.add_column('media_items', 'mshs_group',
                      self.gf('telemeta.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaItem.mshs_musical_organization'
        db.delete_column('media_items', 'mshs_musical_organization')

        # Deleting field 'MediaItem.mshs_group'
        db.delete_column('media_items', 'mshs_group')
    ...
    models = {
        ...
        'telemeta.mediaitem': {
            ...
            'mshs_group': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            ...
            'mshs_musical_organization': ('telemeta.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
