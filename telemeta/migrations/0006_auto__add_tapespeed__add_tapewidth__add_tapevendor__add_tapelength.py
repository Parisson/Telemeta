...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TapeSpeed'
        db.create_table('tape_speed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('telemeta.models.core.CharField')(unique=True, max_length=250)),
        ))
        db.send_create_signal('telemeta', ['TapeSpeed'])

        # Adding model 'TapeWidth'
        db.create_table('tape_width', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('telemeta.models.core.CharField')(unique=True, max_length=250)),
        ))
        db.send_create_signal('telemeta', ['TapeWidth'])

        # Adding model 'TapeVendor'
        db.create_table('tape_vendor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('telemeta.models.core.CharField')(unique=True, max_length=250)),
        ))
        db.send_create_signal('telemeta', ['TapeVendor'])

        # Adding model 'TapeLength'
        db.create_table('tape_length', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('telemeta.models.core.CharField')(unique=True, max_length=250)),
        ))
        db.send_create_signal('telemeta', ['TapeLength'])

    def backwards(self, orm):
        # Deleting model 'TapeSpeed'
        db.delete_table('tape_speed')

        # Deleting model 'TapeWidth'
        db.delete_table('tape_width')

        # Deleting model 'TapeVendor'
        db.delete_table('tape_vendor')

        # Deleting model 'TapeLength'
        db.delete_table('tape_length')
