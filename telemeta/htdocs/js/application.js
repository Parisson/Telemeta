...
//var PopupClass=function(innerHTML,event){
//    var $J = jQuery; //reference to jQuery
//    var className = 'component'; //the optional div class name
//    var div = $J('<div/>').css({  //create the div (the popup)
//                position: 'absolute',
//                overflow:'auto', //necessary to properly display the content
//                display: 'none',
//                zIndex:1000
...
//         div.html(content);
//     }
//     //create the div shadow
//     var divShadow = div.clone(false,false).empty().css({'zIndex':999,'borderColor':'#000','display':'none','backgroundColor':'#000'}).insertAfter(div);
//     //append to the body
//     var body = $J('body');
//     body.append(div);
//     divShadow.insertAfter(div);
//     div = div.add(divShadow);
//     //set the id
//     var time = new Date().getTime();
//     div.attr('id','popup_'+time);
//     divShadow.attr('id','popupshadow_'+time);
//     //make thid class a jQuery object:
//     $J.extend(this,div);
//     //override some methods:
//     //
//     //private function which binds/unbinds click and key events
//     var toggleBind = function(element, callback){
//            var clickNamespace = "click.popup__"+time;
//            var keydownNamespace =  "keyup.popup__"+time;
//            element.unbind(clickNamespace);
//            element.unbind(keydownNamespace);
//            if(callback){
//                element.bind(clickNamespace, callback);
//                element.bind(keydownNamespace,callback);
//            }
//        };
//
//     var doc = $J(document); //reference to the document
//
//     //hide:
//     var hide = this.hide;
//     this.hide = function(){
...
//         me.hide();
//         remove.apply(me,arguments);
//     };
//
//     //show:
//     var shadowOffset = 5; //the shadow offset, change to increment/ decrement
//     var show = this.show;
//
//     this.show = function(){
//         place($J(me[0]),event);
//         var position = $J(me[0]).offset();
//         $J(me[1]).css({
//                'top': (position.top + shadowOffset),
//                'left': (position.left + shadowOffset),
//                'width': div.outerWidth(true),
