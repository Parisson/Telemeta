...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WheelDiameter'
        db.create_table('tape_wheel_diameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('telemeta.models.core.CharField')(unique=True, max_length=250)),
        ))
        db.send_create_signal('telemeta', ['WheelDiameter'])
        ...
        # Deleting field 'Format.tape_number'
        db.delete_column('media_formats', 'tape_number')

        # Deleting field 'Format.tape_length'
        db.delete_column('media_formats', 'tape_length_id')

        # Adding field 'Format.original_format'
        db.add_column('media_formats', 'original_format',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='format', null=True, blank=True, to=orm['telemeta.OriginalFormat']),
                      keep_default=False)
        ...
        # Adding field 'Format.sticker_presence'
        db.add_column('media_formats', 'sticker_presence',
                      self.gf('telemeta.models.core.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Format.recording_system'
        db.add_column('media_formats', 'recording_system',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting model 'WheelDiameter'
        db.delete_table('tape_wheel_diameter')

        # Deleting model 'OriginalFormat'
        db.delete_table('original_format')

        # Adding field 'Format.tape_number'
        db.add_column('media_formats', 'tape_number',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Format.tape_length'
        db.add_column('media_formats', 'tape_length',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='formats', null=True, to=orm['telemeta.TapeLength'], blank=True),
                      keep_default=False)

        # Deleting field 'Format.original_format'
        db.delete_column('media_formats', 'original_format_id')
        ...
        # Deleting field 'Format.sticker_presence'
        db.delete_column('media_formats', 'sticker_presence')

        # Deleting field 'Format.recording_system'
        db.delete_column('media_formats', 'recording_system')
