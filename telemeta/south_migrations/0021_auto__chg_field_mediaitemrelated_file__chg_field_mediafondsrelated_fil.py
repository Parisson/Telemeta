...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MediaItemRelated.file'
        db.alter_column('media_item_related', 'filename', self.gf('telemeta.models.core.FileField')(max_length=100, db_column='filename'))

        # Changing field 'MediaFondsRelated.file'
        db.alter_column('media_fonds_related', 'filename', self.gf('telemeta.models.core.FileField')(max_length=100, db_column='filename'))

        # Changing field 'MediaCorpusRelated.file'
        db.alter_column('media_corpus_related', 'filename', self.gf('telemeta.models.core.FileField')(max_length=100, db_column='filename'))

        # Changing field 'MediaCollectionRelated.file'
        db.alter_column('media_collection_related', 'filename', self.gf('telemeta.models.core.FileField')(max_length=100, db_column='filename'))
    models = {
        'auth.group': {
