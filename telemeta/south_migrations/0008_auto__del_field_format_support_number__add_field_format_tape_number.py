...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Format.support_number'
        db.delete_column('media_formats', 'support_number')
    ...
    def backwards(self, orm):
        # Adding field 'Format.support_number'
        db.add_column('media_formats', 'support_number',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)
