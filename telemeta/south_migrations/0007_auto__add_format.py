...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Format'
        db.create_table('media_formats', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('telemeta.models.core.ForeignKey')(related_name='formats', to=orm['telemeta.MediaItem'])),
            ('original_code', self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True)),
            ('support_number', self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True)),
            ('status', self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True)),
            ('conservation_state', self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True)),
            ('comments', self.gf('telemeta.models.core.TextField')(default='', blank=True)),
            ('tape_length', self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='formats', null=True, blank=True, to=orm['telemeta.TapeLength'])),
            ('tape_width', self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='formats', null=True, blank=True, to=orm['telemeta.TapeWidth'])),
            ('tape_speed', self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='formats', null=True, blank=True, to=orm['telemeta.TapeSpeed'])),
            ('tape_vendor', self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='formats', null=True, blank=True, to=orm['telemeta.TapeVendor'])),
            ('tape_thickness', self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True)),
            ('tape_diameter', self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True)),
            ('tape_reference', self.gf('telemeta.models.core.CharField')(default='', max_length=250, blank=True)),
        ))
        db.send_create_signal('telemeta', ['Format'])

    def backwards(self, orm):
        # Deleting model 'Format'
        db.delete_table('media_formats')
    ...
    models = {
        ...
        'telemeta.format': {
            ...
            'support_number': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
