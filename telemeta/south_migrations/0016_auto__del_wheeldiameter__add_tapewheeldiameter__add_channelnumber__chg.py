...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TapeWheelDiameter'
        db.create_table('tape_wheel_diameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('telemeta.models.core.CharField')(unique=True, max_length=250)),
        ))
        db.send_create_signal('telemeta', ['TapeWheelDiameter'])

        # Adding model 'ChannelNumber'
        db.create_table('original_channel_number', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('telemeta.models.core.CharField')(unique=True, max_length=250)),
        ))
        db.send_create_signal('telemeta', ['ChannelNumber'])


        # Renaming column for 'Format.original_channels' to match new field type.
        db.rename_column('media_formats', 'original_channels', 'original_channels_id')
        # Changing field 'Format.original_channels'
        db.alter_column('media_formats', 'original_channels_id', self.gf('telemeta.models.core.WeakForeignKey')(null=True, to=orm['telemeta.ChannelNumber']))
        # Adding index on 'Format', fields ['original_channels']
        db.create_index('media_formats', ['original_channels_id'])
    ...
    def backwards(self, orm):
        # Removing index on 'Format', fields ['original_channels']
        db.delete_index('media_formats', ['original_channels_id'])
        ...
        # Deleting model 'TapeWheelDiameter'
        db.delete_table('tape_wheel_diameter')

        # Deleting model 'ChannelNumber'
        db.delete_table('original_channel_number')


        # Renaming column for 'Format.original_channels' to match new field type.
        db.rename_column('media_formats', 'original_channels_id', 'original_channels')
        # Changing field 'Format.original_channels'
        db.alter_column('media_formats', 'original_channels', self.gf('telemeta.models.core.IntegerField')())

        # Changing field 'Format.tape_wheel_diameter'
        db.alter_column('media_formats', 'tape_wheel_diameter_id', self.gf('telemeta.models.core.WeakForeignKey')(null=True, to=orm['telemeta.WheelDiameter']))
    models = {
        'auth.group': {
        ...
        'telemeta.channelnumber': {
            'Meta': {'ordering': "['value']", 'object_name': 'ChannelNumber', 'db_table': "'original_channel_number'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('telemeta.models.core.CharField', [], {'unique': 'True', 'max_length': '250'})
        },
        ...
        'telemeta.format': {
            ...
            'original_channels': ('telemeta.models.core.WeakForeignKey', [], {'default': 'None', 'related_name': "'format'", 'null': 'True', 'blank': 'True', 'to': "orm['telemeta.ChannelNumber']"}),
