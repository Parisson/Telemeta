...
class MediaItem(MediaResource):
    ...
    mshs_informers        = models.ManyToManyField('MediaCollectionPerformance', verbose_name=_('Informateur(s)'))
    mshs_timbre           = CharField(_("Timbre de l'air"))
    mshs_timbre_ref       = CharField(_(u"Timbre(s) référencé(s)"))
    mshs_timbre_code      = CharField(_('Cote du timbre'))
    mshs_melody           = TextField(_(u"Mélodie (transcription alphabétique)"), help_text=_('You can use ABC notation'))
    DOMAINS = (
        ('T','Témoignage'),
        ('C','Chanson'),
    ...
    mshs_domain_vocal     = CharField(_("Genre(s) de l'Autre expression vocale"))
    mshs_domain_music     = CharField(_("Genre(s) de l'Expression instrumentale"))
    mshs_domain_tale      = CharField(_("Genre(s) du Conte"))
    mshs_details          = TextField(_(u"Précisions sur l'item"))
    mshs_function         = CharField(_('Fonction(s)'))
    mshs_dance            = CharField(_('Danse(s)'))
    mshs_dance_details    = TextField(_(u"Précisions sur la danse"))
    mshs_deposit_digest   = TextField(_(u"Résumé"))
    mshs_deposit_thematic = CharField(_(u"Thématiques"))
    mshs_deposit_names    = CharField(_(u"Nom(s) propre(s) cité(s) "), help_text=_('First name, Last name ; First name, Last name'))
    mshs_deposit_places   = CharField(_(u"Lieu(x) cité(s)"), help_text=_('Place named; place named; ...'))
    mshs_deposit_periods  = CharField(_(u"Période(s) citée(s)"), help_text=_('Period recounted; period recounted; ...'))
    ...
    mshs_musical_organization = CharField(_(u"Organisation musicale"))
    mshs_group            = CharField(_('Formation'))
